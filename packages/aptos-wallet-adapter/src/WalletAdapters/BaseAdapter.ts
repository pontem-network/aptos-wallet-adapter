...
export class TransactionScriptFunctionPayloadOfRawArguments {
  constructor(
    public payload: Omit<TransactionPayload_ScriptFunctionPayload, 'arguments'> & {
  ...
  toJSONPayload(): TransactionPayload_ScriptFunctionPayload {
    return {
  ...
  toBCSPayload(): TransactionPayloadScriptFunction {
    ...
    return new TxnBuilderTypes.TransactionPayloadScriptFunction(
      TxnBuilderTypes.ScriptFunction.natural(
        module,
        func,
        tyArgs,
        TransactionScriptFunctionPayloadOfRawArguments.rawArgumentsToBytesSeq(
...
export type TransactionPayloadScriptFunctionGeneric =
  ...
  | TransactionScriptFunctionPayloadOfRawArguments;
